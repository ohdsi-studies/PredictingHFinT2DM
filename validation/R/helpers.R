...
addCohortNames <- function(data, IdColumnName = "cohortDefinitionId", nameColumnName = "cohortName") {
  pathToCsv <- system.file("settings", "CohortsToCreate.csv", package = "HFinT2DMNoInsulinValidation")
...
.createCohorts <- function(connection,
  ...
  pathToCustom <- system.file("settings", 'cohortVariableSetting.csv', package = "HFinT2DMNoInsulinValidation")
  if(pathToCustom!=""){
