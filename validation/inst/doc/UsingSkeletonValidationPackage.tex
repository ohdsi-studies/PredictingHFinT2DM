...
\NormalTok{devtools}\OperatorTok{::}\KeywordTok{install_github}\NormalTok{(}\StringTok{"OHDSI-studies/HFinT2DMNoInsulinValidation"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{library}\NormalTok{(HFinT2DMNoInsulinValidation)}
\NormalTok{?execute}
\end{Highlighting}
\end{Shaded}
