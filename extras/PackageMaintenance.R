...
OhdsiRTools::checkUsagePackage("HFinT2DMNoInsulin")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/HFinT2DMNoInsulin.pdf")
shell("R CMD Rd2pdf ./ --output=extras/HFinT2DMNoInsulin.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("HFinT2DMNoInsulin")
